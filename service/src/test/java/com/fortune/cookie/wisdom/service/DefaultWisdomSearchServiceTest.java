...
public class DefaultWisdomSearchServiceTest {
	@InjectMocks
	private DefaultWisdomSearchService underTest;
	@Mock
	...
	public void testGetCategoriesShouldCallRepoApiAndtransformResponse() throws URISyntaxException {
		...
		BDDMockito.given(transformer.convertResponseToWisdoms(responseBody, String.class))
		...
		BDDMockito.then(transformer).should(BDDMockito.times(1)).convertResponseToWisdoms(responseBody, String.class);
	}
	...
	public void testGetWisdomsByCategoryShouldCallRepoApiAndtransformResponse() throws URISyntaxException {
		...
		BDDMockito.then(restTemplate).should(BDDMockito.times(1)).getForEntity(uri, String.class);
		BDDMockito.then(transformer).should(BDDMockito.times(1)).convertResponseToWisdoms(responseBody, Wisdom.class);
	}
